...
const ALL_PROJECTS = [
  {
    title: 'Rapid Research Synthesis',
    tagline: 'AI-assisted literature review tool',
    type: 'embedded',
    embedPath: 'projects/rrs/index.html',
    desc: 'A tool that helps researchers rapidly synthesize literature using AI-assisted extraction, organization, and visualization of key findings across papers.',
    tags: ['AI', 'Research Tools', 'NLP'],
    status: 'Live',
    role: 'Lead Developer',
  },
  {
    title: 'MathReason',
    tagline: 'Making mathematical thinking visible',
    type: 'showcase',
