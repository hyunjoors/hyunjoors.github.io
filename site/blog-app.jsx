...
const BLOG_ALL = [
  {
    id: 'ai-facilitator',
    title: 'Rethinking AI as a Learning Facilitator',
    date: 'April 12, 2026',
    tag: 'Research',
    readTime: '8 min',
    excerpt: 'What if we stopped asking "Can AI teach?" and started asking "Can AI help students teach each other?" This shift in framing opens up an entirely different design space for educational technology — one that centers student reasoning rather than content delivery.',
    body: `The dominant narrative around AI in education frames it as a replacement for human instruction. Chatbots answer questions. Tutoring systems drill procedures. Recommendation engines optimize content delivery.\n\nBut what if we reframed the question entirely?\n\nInstead of asking "Can AI teach?", I've been exploring: "Can AI help make student thinking visible — to peers, to teachers, and to themselves?"\n\nThis reframing leads to fundamentally different design decisions. Rather than building systems that explain concepts, we build systems that prompt students to explain their own reasoning. Rather than optimizing for correct answers, we optimize for productive mathematical discourse.\n\nIn my current work on MathReason, we're designing AI scaffolds that:\n\n• Ask students to represent their thinking in multiple ways\n• Surface patterns across student approaches for teachers\n• Create structured opportunities for peer collaboration\n• Flag moments of productive confusion rather than treating all errors as failures\n\nThe early results suggest that when AI plays a facilitative role, students develop stronger conceptual understanding — not because the AI taught them, but because it created conditions for them to teach each other.\n\nMore on this in my upcoming AERA presentation.`,
  },
  {
    id: 'cat-parent-phd',
